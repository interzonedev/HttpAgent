...
public class HttpComponentsRequestService implements RequestService {
	 ...
	 * 
	 * @param request
	 *            The {@link Request} value object that contains the components of the {@link HttpRequestBase} to
	 *            assemble.
	 * 
	 ...
	 * 
	 * @param request
	 *            The {@link Request} value object that represents the originiating HTTP request.
	 * @param httpResponse
	 *            The {@link HttpResponse} that represents the response to transform into a {@link Response}.
	 * 
